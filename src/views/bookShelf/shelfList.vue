      ...
      storyCategory: [
        {
          ...
          title: "玄幻",
          img:
            "http://imgsrc.baidu.com/baike/abpic/item/0dd7912397dda144f6905e65b8b7d0a20df4864f.jpg",
          context:
            "文体光怪陆离如穿越、东方玄幻、修真仙侠、高武，甚或改编电影动漫等等不一而足"
        },
        {
          category_id: "urban",
          title: "都市",
          img:
            "http://imgsrc.baidu.com/baike/abpic/item/8b82b9014a90f603bf2f82853712b31bb151ed51.jpg",
          context:
            "文体光怪陆离如穿越、东方玄幻、修真仙侠、高武，甚或改编电影动漫等等不一而足"
        },
        {
...
.classification .shelfList li:nth-child(2n-1) {
  margin-right: 10px;
}
.classification .shelfList li .shelfBox {
  width: 100%;
  height: 75%;
  display: flex;
  justify-content: space-between;
...
.classification .shelfList li .shelfBox div {
