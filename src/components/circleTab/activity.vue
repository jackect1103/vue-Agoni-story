...
export default {
  ...
  data() {
    return {
      dataList: [
        {
          title: "纪念路遥诞辰70周年：“我的平凡的世界”征文比赛启动",
          img:
            "http://n.sinaimg.cn/book/275/w165h110/20190916/1e4d-ietnfsp3989277.jpg",
          content:
        ...
        {
          title: "第29届全国图书交易博览会将于7月底在陕西西安举行",
          img:
            "http://n.sinaimg.cn/book/199/w1920h679/20190712/dcbd-hzuhxyn6367185.jpg",
          content:
            "王亭之，香港“食神”级人物，食界引路人之一，多款食制的创立者及幕后推手。《王亭之谈食》，一部写在传统饮食文化潮起潮落时代的批评小品，一述中餐饮食砧炉盘盏间的趣秘。文笔风趣，且见性情。劝诫垂范...",
          date: new Date().getMonth() + 1 + "月" + new Date().getDate() + "号"
        },
        {
          title: "第十七届华语文学传媒盛典颁奖礼5月25日与读者相约",
          img:
            "http://n.sinaimg.cn/book/275/w165h110/20190523/7547-hxntqyx7733515.jpg",
          content:
